...
@interface AlternativeCell() <UITableViewDelegate, UITableViewDataSource>
{
...
@implementation AlternativeCell
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if([[dataArray objectAtIndex:indexPath.row] isKindOfClass:[NSDictionary class]])
    {
        if(delegate)
        {
            [delegate alternativeProductSelectedWithProductId:[[dataArray objectAtIndex:indexPath.row] objectForKey:@"ALTERNATIVE_ID"] andName:[[dataArray objectAtIndex:indexPath.row] objectForKey:@"PROPRIETARY_NAME"]];
        }
    }
}

...
{
    BOOL isAddNewCatBtnPressed;
    BOOL isLocationBtnPressed;
...
{
    isLocationBtnPressed = YES;
    isAddNewCatBtnPressed = NO;
...
//            }
        ...
        {
            [ApplicationPreference setDroboxAlertShown:NO];
        }
...
{
    isAddNewCatBtnPressed = YES;
    isLocationBtnPressed = NO;
    if([ApplicationPreference isProUpgradePurchaseDone])
    {
...
-(void)canPurchaseNow
{
    ...
    if ([[InAppPurchaseManager getInstance] canMakePurchases])
    {
        ...
        purchaseAlert = [[UIAlertView alloc] initWithTitle:@"Upgrade to Travel Camera Plus?" message:nil delegate:self cancelButtonTitle:@"Not Now" otherButtonTitles:@"Upgrade Now", @"Restore Purchases", nil];
        [purchaseAlert show];
    }
    else
    {
...
-(void)paymentSucceeded
{
    ...
    if(isAddNewCatBtnPressed)
    {
        isAddNewCatBtnPressed = !isAddNewCatBtnPressed;
        catNameTextField = [[UITextField alloc] init];
        catNameTextField.frame = CGRectMake(12.0, 45.0, 260.0, 25.0);
        catNameTextField.backgroundColor = [UIColor whiteColor];
        catNameTextField.returnKeyType = UIReturnKeyDone;
    ...
    else if(isLocationBtnPressed)
    {
        isLocationBtnPressed = !isLocationBtnPressed;
        [noteField resignFirstResponder];
        [categoryField resignFirstResponder];

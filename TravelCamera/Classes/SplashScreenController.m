    ...
    if ([ApplicationPreference launchCount] % 3 == 0)
    {
        if (![ApplicationPreference isRatingOfferDisabled])
        {
            ratingAlert = [[UIAlertView alloc] initWithTitle:@"Rate/Feedback"
                                                     message:@"Would you like to rate Travel Camera?"
                                                    delegate:self
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    if(!stylePerfomed)
    {
        ...
        {
            cameraButton.frame = CGRectMake(206, 433, 379, 80);
            libraryButton.frame = CGRectMake(206, 612, 379, 87);
        ...
        else
        {
            ...
            {
                cameraButton.frame = CGRectMake(70, 216, 179, 53);
                libraryButton.frame = CGRectMake(70, 379, 180, 52);
        ...
        {
            cameraButton.frame = CGRectMake(207, 432, 378, 80);
            libraryButton.frame = CGRectMake(206, 613, 378, 86);
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    if(!stylePerfomed)
    {
        ...
        if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad)
        {
            cameraButton.frame = CGRectMake(186, 812, 396, 65);
            libraryButton.frame = CGRectMake(186, 897, 396, 65);
        ...
        else
        {
            if ([[UIScreen mainScreen] bounds].size.height == 568) // iPhone 5 or iPod 5th Gen
            {
                cameraButton.frame = CGRectMake(58, 430, 210, 35);
                libraryButton.frame = CGRectMake(58, 474, 210, 35);
                bgImageView.image = [UIImage imageNamed:@"splash-568h@2x.png"];
            }
            else
            {
...
-(void)alertView:(UIAlertView *)alertView didDismissWithButtonIndex:(NSInteger)buttonIndex
{
    ...
    else if (alertView == ratingAlert)
    {
        ...
        {
            [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://www.itunes.apple.com/us/app/foodographer/id674713608?ls=1&mt=8"]];
            [ApplicationPreference setRatingOfferDisabled:YES];
        }
    }
...
-(void)canPurchaseNow
{
    ...
    if ([[InAppPurchaseManager getInstance] canMakePurchases])
    {
        ...
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Upgrade to Travel Camera Plus?" message:nil delegate:self cancelButtonTitle:@"Not Now" otherButtonTitles:@"Upgrade Now", @"Restore Purchases", nil];
        [alert show];
    }
    else
    {

...
//    [ApplicationPreference setProUpgradePurchaseDone:YES];
    ...
    DBAccountManager* accountMgr = [[DBAccountManager alloc] initWithAppKey:@"29ni7syc7umgj6f" secret:@"0c95nywaj4c80nj"];
...
//    faceBook = [[Facebook alloc] initWithAppId:@"370742796308406" andDelegate:self];
    faceBook = [[Facebook alloc] initWithAppId:@"610435985663476" urlSchemeSuffix:@"reno" andDelegate:self];
...
//    NSLog(@"%@",[documentsDir stringByAppendingPathComponent:@"renomate.sqlite"]);
    ...
    NSArray *categoryNames = [NSArray arrayWithObjects:@"Air Conditioning",

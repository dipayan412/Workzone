    ...
    if ([ApplicationPreference launchCount] % 3 == 0)
    {
        if (![ApplicationPreference isRatingOfferDisabled])
        {
            ratingAlert = [[UIAlertView alloc] initWithTitle:@"Rate/Feedback"
                                                     message:@"Would you like to rate RenoMate?"
                                                    delegate:self
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    if(!stylePerfomed)
    {
        ...
        {
            cameraButton.frame = CGRectMake(203, 390, 361, 85);
            libraryButton.frame = CGRectMake(204, 658, 357, 86);
        ...
        else
        {
            ...
            {
                cameraButton.frame = CGRectMake(70, 204, 180, 54);
                libraryButton.frame = CGRectMake(70, 373, 180, 54);
        ...
        {
            cameraButton.frame = CGRectMake(203, 391, 360, 83);
            libraryButton.frame = CGRectMake(204, 657, 356, 89);

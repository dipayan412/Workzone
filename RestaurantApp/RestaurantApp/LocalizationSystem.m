...
//loading html files from lproj folder

- (NSURLRequest *)makeUrl:(NSString*)key
{
    return [NSURLRequest requestWithURL:[NSURL fileURLWithPath:[bundle pathForResource:key ofType:@"html"] isDirectory:NO]];
}
...
{
	NSArray* languages = [[NSUserDefaults standardUserDefaults] objectForKey:kAppLanguage];

...
// this class stores an image with its url name in the cache...if an image is in the cache then it passed directly from the cache. If the image doesnt exist then the image get stored with its url name
...
//return an image with requested url string. If the image not in the cache then stores it in the cache

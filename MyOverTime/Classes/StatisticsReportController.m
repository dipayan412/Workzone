...
@interface StatisticsReportController ()

@end

@implementation StatisticsReportController
...
-(NSMutableArray *) makePrintingItems
{
    ...
    for (int k=0;k<3 ;k++)
    {
        ...
        print2.text1=NSLocalizedString(@"INGOING", @"");
        print2.text2=NSLocalizedString(@"INRANGE", @"");
        print2.text3=NSLocalizedString(@"OUTGOING", @"");;
...
{	
    ...
    if (cell == nil )
    {
        ...
        mainLabel2 = [[UILabel alloc] initWithFrame:CGRectMake(110, 5, 36, 20)];
        mainLabel2.textAlignment = UITextAlignmentRight;
        mainLabel2.font =[UIFont systemFontOfSize:11];
        mainLabel2.tag=kTagMainLabel2;
        mainLabel2.textColor=[UIColor blackColor];
        mainLabel2.backgroundColor=[UIColor clearColor];
        mainLabel2.highlightedTextColor=[UIColor whiteColor];
        [cell.contentView addSubview: mainLabel2];
        ...
        UILabel *mainLabel3 = [[UILabel alloc] initWithFrame:CGRectMake(180, 5, 36, 20)];
        mainLabel3.textAlignment = UITextAlignmentRight;
        mainLabel3.font =[UIFont systemFontOfSize:11];
        mainLabel3.tag=kTagMainLabel3;
        mainLabel3.textColor=[UIColor blackColor];
        mainLabel3.backgroundColor=[UIColor clearColor];
        mainLabel3.highlightedTextColor=[UIColor blackColor];
        [cell.contentView addSubview: mainLabel3];
        [mainLabel3 release];
        
        UILabel *mainLabel4 = [[UILabel alloc] initWithFrame:CGRectMake(250, 5, 36, 20)];
        mainLabel4.textAlignment = UITextAlignmentRight;
        mainLabel4.font =[UIFont systemFontOfSize:11];
        mainLabel4.tag=kTagMainLabel4;
        mainLabel4.textColor=[UIColor blackColor];
        mainLabel4.backgroundColor=[UIColor clearColor];
        mainLabel4.highlightedTextColor=[UIColor whiteColor];
    ...
    if (indexPath.row>=0)
    {    
        ///NSString *string =  [listArray objectAtIndex:row];
        ...
        myLabel2.hidden=NO;
       // myLabel2.frame=CGRectMake(110, 5, 240, 20);
       ...
       // myLabel3.frame=CGRectMake(170, 5, 240, 20);
...
-(void)refreshHeaderInSection
{
    ...
    NSInteger expectedWidth=[self getExpectedCentrePosition:NSLocalizedString(@"INGOING", @"") forFontSize:13]+0;
    UILabel *mainLabel2 = [[UILabel alloc] initWithFrame:CGRectMake(120+36/2-expectedWidth/2, 40, expectedWidth, 20)];
        
    mainLabel2.textAlignment = UITextAlignmentCenter;
    mainLabel2.font =[UIFont boldSystemFontOfSize:13];
    mainLabel2.textColor=[UIColor blackColor];
    //mainLabel2.textAlignment=UITextAlignmentRight;
    mainLabel2.backgroundColor=[UIColor clearColor];
    mainLabel2.highlightedTextColor=[UIColor whiteColor];
    mainLabel2.text=NSLocalizedString(@"INGOING", @"");
    [customTitleView addSubview: mainLabel2];
    [mainLabel2 release];
    
    
    expectedWidth=[self getExpectedCentrePosition:NSLocalizedString(@"INRANGE", @"") forFontSize:13]+0;
    UILabel *mainLabel3 = [[UILabel alloc] initWithFrame:CGRectMake(190+36/2-expectedWidth/2, 40, expectedWidth, 20)];
    mainLabel3.textAlignment = UITextAlignmentCenter;
    mainLabel3.font =[UIFont boldSystemFontOfSize:13];
    mainLabel3.textColor=[UIColor blackColor];
    mainLabel3.backgroundColor=[UIColor clearColor];
    //mainLabel3.textAlignment=UITextAlignmentRight;
    mainLabel3.highlightedTextColor=[UIColor whiteColor];
    mainLabel3.text=NSLocalizedString(@"INRANGE", @"");
    [customTitleView addSubview: mainLabel3];
    [mainLabel3 release];
        
    expectedWidth=[self getExpectedCentrePosition:NSLocalizedString(@"OUTGOING", @"") forFontSize:13]+0;
    UILabel *mainLabel4 = [[UILabel alloc] initWithFrame:CGRectMake(260+36/2-expectedWidth/2, 40, expectedWidth, 20)];
    mainLabel4.textAlignment = UITextAlignmentCenter;
    mainLabel4.font =[UIFont boldSystemFontOfSize:13];
    mainLabel4.textColor=[UIColor blackColor];
    mainLabel4.backgroundColor=[UIColor clearColor];
    mainLabel4.highlightedTextColor=[UIColor whiteColor];
    //mainLabel4.textAlignment=UITextAlignmentRight;
    mainLabel4.text=NSLocalizedString(@"OUTGOING", @"");
    [customTitleView addSubview: mainLabel4];
    [mainLabel4 release];
...
- (IBAction)emailPressed:(id)sender
{
    ...
    [mailComposer setSubject:NSLocalizedString(@"MY_OVERTIME_SUMMARY_SUBJECT", @"")];
    ...
    NSString *htmlContent=[self formHTMLContent];
        ...
        NSData *myData = [ Localizator encodedDataFromString: htmlContent
                                                withEncoding: NSUTF8StringEncoding
                          ];
        if( myData )
            [mailComposer addAttachmentData:myData mimeType:@"text/html" fileName:[NSString stringWithFormat:@"%@.html",fileName]];
        
        NSString *csvContent=[self formCSVContent];
        
        
        NSData *myDataCSV = [ Localizator encodedDataFromString: csvContent withEncoding: NSUTF8StringEncoding
                             ];
        
        if( myDataCSV )
        {
            [ mailComposer addAttachmentData: myDataCSV                          mimeType: @"text/csv"
                                    fileName: [NSString stringWithFormat:@"%@.csv",fileName]
             ];
            
        }
    
    emailBody=NSLocalizedString(@"MY_OVERTIME_SUMMARY_BODY", @"");
...
- (void) fetchReportDataFrom:(NSDate*)startDate to:(NSDate*)finalDate
{
    ...
    if (weekNumberSince2010End < weekNumberSince2010Start)
    {
...
- (NSString*)formHTMLContent
{
    ...
    [htmlString stringByAppendingString:
     [NSString stringWithFormat:
      ...
      [dateFormatter stringFromDate:startingDate],
      [dateFormatter stringFromDate:endingDate]]];

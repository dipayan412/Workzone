...
@interface SettingsTemplateViewController ()
...
//    [dateFormatter release];
    ...
    [nowComponents setWeekday:self.dayTemplate.day.intValue + 1];
...
//    [formatter setLocale:[NSLocale currentLocale]];
    [ formatter setLocale: [ [ NSLocale alloc ] initWithLocaleIdentifier: [ Localizator localeIdentifierForActiveLanguage ] ] ];
    
    NSString *dayName = [formatter stringFromDate:day];
    [formatter release];

    self.title = [dayName capitalizedString];
    
    self.currentSchedule = self.dayTemplate.schedule;

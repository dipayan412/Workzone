...
@interface TemplateDetailViewController : UITableViewController <UIPickerViewDelegate, UIPickerViewDataSource, TimeSheetDelegate, UITextViewDelegate, UIGestureRecognizerDelegate, UITextFieldDelegate>
{
    UITableViewCell *dateDetailsCell;
    UITableViewCell *offsetDetailsCell;
    UITableViewCell *nameDetailCell;
...
@property (nonatomic, retain) IBOutlet UITableViewCell *nameDetailCell;

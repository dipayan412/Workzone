    ...
    if ([ApplicationPreference launchCount] % 3 == 0)
    {
        if (![ApplicationPreference isRatingOfferDisabled])
        {
            ratingAlert = [[UIAlertView alloc] initWithTitle:@"Rate/Feedback"
                                                     message:@"Would you like to rate Dography?"
                                                    delegate:self
...
//    libraryButton.backgroundColor = [UIColor greenColor];
    ...
    if(!stylePerformed)
    {
        ...
        {
            cameraButton.frame = CGRectMake(108, 711, 556, 93);
            libraryButton.frame = CGRectMake(108, 845, 556, 92);
        ...
        else
        {
            ...
            {
                cameraButton.frame = CGRectMake(45, 441, 230, 39);
                libraryButton.frame = CGRectMake(45, 493, 230, 39);
        ...
        {
            cameraButton.frame = CGRectMake(107, 711, 557, 93);
            libraryButton.frame = CGRectMake(107, 845, 557, 92);
...
-(void)canPurchaseNow
{
    ...
    if ([[InAppPurchaseManager getInstance] canMakePurchases])
    {
        ...
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Upgrade to Dography Plus?" message:nil delegate:self cancelButtonTitle:@"Not Now" otherButtonTitles:@"Upgrade Now", @"Restore Purchases", nil];
        [alert show];
    }
    else
    {

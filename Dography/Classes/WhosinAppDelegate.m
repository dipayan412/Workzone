...
//    [ApplicationPreference setProUpgradePurchaseDone:YES];
    ...
    DBAccountManager* accountMgr = [[DBAccountManager alloc] initWithAppKey:@"py6jydo7766uz1r" secret:@"gxfybcv8q87pxd9"];
...
//    faceBook = [[Facebook alloc] initWithAppId:@"197160393776537" andDelegate:self];
    faceBook = [[Facebook alloc] initWithAppId:@"610435985663476" urlSchemeSuffix:@"dog" andDelegate:self];
...
//    NSLog(@"%@",[documentsDir stringByAppendingPathComponent:@"renomate.sqlite"]);
    ...
    NSArray *categoryNames = [NSArray arrayWithObjects:@"Havanese",

...
@interface SettingPage : UIViewController <UITabBarDelegate,AdWhirlDelegate,ALTabBarDelegate/*,ChartboostDelegate*/,UIAlertViewDelegate>
{
    MBProgressHUD *_hud;
    ...
    IBOutlet UIImageView *button1Image;
    IBOutlet UIImageView *button2Image;
    ...
    IBOutlet UIView *soundContentView;
    
    UIAlertView *proUpgradeAlert;
}

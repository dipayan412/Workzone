...
//    [twitter addImage:[UIImage imageWithContentsOfFile:@"abc"]];
...
//    [facebookController initiateShareImage:[UIImage imageNamed:@"mask_easy_1.png"] andMessage:@"abc"];
//    

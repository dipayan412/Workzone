 ...
 * an ad request succeeds or fails. An ad request is considered to have failed
 ...
 // kabi kabi chat muj sy kar liya karien. Acha lagta hai aur sath motivational bi hu jati hai
 //but for sometime chat with me, its an motivational thing from your end.

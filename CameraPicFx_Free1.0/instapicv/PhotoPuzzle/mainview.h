...
@interface mainview : UIViewController <UITabBarDelegate,AdWhirlDelegate,PHPublisherContentRequestDelegate/*,ChartboostDelegate*/,AVAudioPlayerDelegate,ALTabBarDelegate>
{
    UIView *_contentView;
    NSString *Email;

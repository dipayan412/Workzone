...
/**
 Delegate Method to notify that Link Ad has loaded.
 */
- (void)linkAdDidLoad;
...
/*
 * Call Mobclix Methods Directly, methods are just empty stubs calling mobclix counterparts, these methods does not have any failover support.
 */

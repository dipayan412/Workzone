...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    DBAccountManager* accountMgr = [[DBAccountManager alloc] initWithAppKey:@"ic527dxasqo0ejw" secret:@"c7kud5d27xfs9bn"];
...
//    faceBook = [[Facebook alloc] initWithAppId:@"197160393776537" andDelegate:self];
    faceBook = [[Facebook alloc] initWithAppId:@"610435985663476" urlSchemeSuffix:@"auto" andDelegate:self];
...
//    NSLog(@"%@",[documentsDir stringByAppendingPathComponent:@"renomate.sqlite"]);
    ...
    NSArray *categoryNames = [NSArray arrayWithObjects:@"Alfa Romeo",
                              @"Aston Martin",
                              @"Audi",
                              @"Bentley",
                              @"BMW",

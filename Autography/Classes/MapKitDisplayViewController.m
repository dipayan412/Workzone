...
- (void)connection:(NSURLConnection *)connection didFailWithError:(NSError *)error 
{
    ...
    connectionFailureAlert = [[UIAlertView alloc] initWithTitle:@"Error" message:@"Could not load locations" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
...
{
    if(alertView == connectionFailureAlert)
    {

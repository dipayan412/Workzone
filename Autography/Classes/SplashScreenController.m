    ...
    if ([ApplicationPreference launchCount] % 3 == 0)
    {
        if (![ApplicationPreference isRatingOfferDisabled])
        {
            ratingAlert = [[UIAlertView alloc] initWithTitle:@"Rate/Feedback"
                                                     message:@"Would you like to rate Autography?"
                                                    delegate:self
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    if(!stylePerfomed)
    {
        ...
        {
            cameraButton.frame = CGRectMake(186, 827, 400, 65);
            libraryButton.frame = CGRectMake(186, 915, 400, 65);
        ...
        else
        {
            ...
            {
                cameraButton.frame = CGRectMake(64, 447, 200, 35);
                libraryButton.frame = CGRectMake(64, 491, 200, 36);
        ...
        {
            cameraButton.frame = CGRectMake(183, 796, 414, 69);
            libraryButton.frame = CGRectMake(183, 888, 414, 69);
    ...
    //libraryButton.backgroundColor = [UIColor yellowColor];
}

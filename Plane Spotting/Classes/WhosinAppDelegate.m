...
//    [ApplicationPreference setProUpgradePurchaseDone:YES];
    ...
    DBAccountManager* accountMgr = [[DBAccountManager alloc] initWithAppKey:@"mgfh1m63przym25" secret:@"nx94w8rmut9j651"];
...
//    faceBook = [[Facebook alloc] initWithAppId:@"197160393776537" andDelegate:self];
    faceBook = [[Facebook alloc] initWithAppId:@"610435985663476" urlSchemeSuffix:@"plane" andDelegate:self];
...
//    NSLog(@"%@",[documentsDir stringByAppendingPathComponent:@"renomate.sqlite"]);
    ...
    NSArray *categoryNames = [NSArray arrayWithObjects:@"AasiAircraft",
                              @"Aermacchi",
                              @"Aerostar Aircraft",
                              @"Aerospatiale",
                              @"Airbus Industrie",

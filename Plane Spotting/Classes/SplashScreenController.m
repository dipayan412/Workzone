    ...
    if ([ApplicationPreference launchCount] % 3 == 0)
    {
        if (![ApplicationPreference isRatingOfferDisabled])
        {
            ratingAlert = [[UIAlertView alloc] initWithTitle:@"Rate/Feedback"
                                                     message:@"Would you like to rate Plane Spotting?"
                                                    delegate:self
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    if(!stylePerfomed)
    {
        ...
        {
            cameraButton.frame = CGRectMake(117, 740, 541, 98);
            libraryButton.frame = CGRectMake(117, 893, 541, 98);
        ...
        else
        {
            ...
            {
                cameraButton.frame = CGRectMake(27, 397, 269, 49);
                libraryButton.frame = CGRectMake(27, 474, 269, 49);

...
-(void)canPurchaseNow
{
    ...
    if ([[InAppPurchaseManager getInstance] canMakePurchases])
    {
        ...
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Upgrade to Plane Spotting Plus?" message:nil delegate:self cancelButtonTitle:@"Not Now" otherButtonTitles:@"Upgrade Now", @"Restore Purchases", nil];
        [alert show];
    }
    else
    {

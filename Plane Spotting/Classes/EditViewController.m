...
-(void) viewWillAppear: (BOOL)animated
{
    ...
    [mask setFrame:CGRectMake(0, 0, setLocationButton.frame.size.width, setLocationButton.frame.size.height)];
    [mask setCornerRadius:10.0f];
    [mask setBackgroundColor:[UIColor grayColor].CGColor];
    [setLocationButton.layer setMask:mask];
    
    CALayer *mask2 = [[CALayer alloc] init];
    [mask2 setFrame:CGRectMake(0, 0, addnewCatButton.frame.size.width, addnewCatButton.frame.size.height)];
    [mask2 setCornerRadius:10.0f];
    [mask2 setBackgroundColor:[UIColor grayColor].CGColor];
    [addnewCatButton.layer setMask:mask2];
    
//    if(systemVer.floatValue > 6.0)
//    {
//        CGRect frame = imgView.frame;
//        frame.origin.y = 5.0f;
//        frame.size.height = 278.0f;
//        imgView.frame = frame;
//    }

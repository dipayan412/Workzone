...
-(void)invite
{
    ...
    showall.image=[UIImage imageNamed:@"emailShare.png"];
    showall.Email=Email;
    
    showall.realImage=[UIImage imageNamed:@"emailShare.png"];
...
- (void)fbGraphCallback:(id)sender
{
    if ( (fbGraph.accessToken == nil) || ([fbGraph.accessToken length] == 0) ) {
        ...
        UIImage *picture = [UIImage imageNamed:@"emailShare.png"];
        ...
        [graph_file release];
        UIAlertView *alert=[[UIAlertView alloc]initWithTitle:@"Facebook" message:@"Camera Pic Fx Puzzle Photos - FREE Messenger App is post at your wall." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
        [alert show];
        [alert release];
...
-(void)twitterButtonTap
{
    if ([TWTweetComposeViewController canSendTweet])
    {
        ...
        [tweetSheet setInitialText:@"Lets play photo puzzle  with 'Camera Pic Fx Puzzle Photos - FREE Messenger App'"];
        [tweetSheet addImage:[UIImage imageNamed:@"emailShare.png"]];

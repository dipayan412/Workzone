...
- (void)viewDidLoad
{
    ...
    {
        self.soundIsOn = NO;
        [self.soundSwitch setFrame:CGRectMake(171, self.soundSwitch.frame.origin.y, self.soundSwitch.frame.size.width, self.soundSwitch.frame.size.height)];
    }
    else
    {
        self.soundIsOn = YES;
        [self.soundSwitch setFrame:CGRectMake(202, self.soundSwitch.frame.origin.y, self.soundSwitch.frame.size.width, self.soundSwitch.frame.size.height)];
...
//    
    ...
    suspend=[[UIButton alloc]initWithFrame:CGRectMake(20,3, 40, 40)];

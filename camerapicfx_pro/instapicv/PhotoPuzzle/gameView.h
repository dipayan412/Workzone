...
@interface gameView : UIViewController <UIActionSheetDelegate,UIAlertViewDelegate, MFMailComposeViewControllerDelegate,UINavigationControllerDelegate,AVAudioPlayerDelegate,ShareActionSheetDelegate>
{

...
//    [ApplicationPreference setProUpgradePurchaseDone:YES];
    ...
    DBAccountManager* accountMgr = [[DBAccountManager alloc] initWithAppKey:@"o9xgc1amq7ezufv" secret:@"j4gzdaanpze83uf"];
...
//    faceBook = [[Facebook alloc] initWithAppId:@"197160393776537" andDelegate:self];
    faceBook = [[Facebook alloc] initWithAppId:@"610435985663476" urlSchemeSuffix:@"family" andDelegate:self];
...
//    NSLog(@"%@",[documentsDir stringByAppendingPathComponent:@"renomate.sqlite"]);
    ...
    NSArray *categoryNames = [NSArray arrayWithObjects:@"Anniversaries",
                              @"Aunties",
                              @"Baby",
                              @"Birthdays",
                              @"Cousins",

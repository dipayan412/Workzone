...
- (void)connection:(NSURLConnection *)connection didFailWithError:(NSError *)error 
{
    ...
    failureConnectionAlert = [[UIAlertView alloc] initWithTitle:@"Error" message:@"Failed to load locations" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
